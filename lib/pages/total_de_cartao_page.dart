import 'package:calculadora_garcom/pages/total_de_taxa_page.dart';
...
class TotalDeCartaoPage extends StatefulWidget {
  const TotalDeCartaoPage({super.key});

  @override
  State<TotalDeCartaoPage> createState() => _TotalDeCartaoPageState();
}

class _TotalDeCartaoPageState extends State<TotalDeCartaoPage> {
